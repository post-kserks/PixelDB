...
You are Worker 1 assigned to implement Milestone 1: Fault Injection (I/O Errors) for Requirement R1.
Your working directory is /Users/xserx/projects/pro-labs/server/.agents/worker_m1.
...
6. Write your handoff report to `/Users/xserx/projects/pro-labs/server/.agents/worker_m1/handoff.md` with build and test command outputs.
