## 2026-07-29T17:47:39Z

You are Worker 2 (Gen2) assigned to implement Milestone 2: Crash Recovery for Requirement R2.
Your working directory is /Users/xserx/projects/pro-labs/server/.agents/worker_m2_gen2.
...
2. Implement `TestChaosCrashRecovery` in `cmd/vaultdb-server/chaos_test.go` (or `internal/core/storage/chaos_test.go` / appropriate package) with build tag `//go:build chaos`.
...
9. Write your handoff report to `/Users/xserx/projects/pro-labs/server/.agents/worker_m2_gen2/handoff.md` with build and test command outputs.
10. Update `/Users/xserx/projects/pro-labs/server/.agents/worker_m2_gen2/progress.md`.
11. Send a summary message back to the orchestrator.
